...
begin
  ...
  if (qry1.Fields[0].asinteger<>0) then begin
    ...
    if (qry1.Fields[0].asinteger<>0) then begin
      ...
      datamodule.DataModule1.qry_refuse_byEmp.SQL.Add('EXEC GetRefusedDemandeOfEmployee @num_emp='+inttostr(dashboard.Form2.num_employee_globalVar));
      datamodule.DataModule1.qry_refuse_byEmp.Open;
